...
function getErrorMessage(error?: string) {
  switch (error) {
    ...
    case "forbidden":
      return "Tu n’as pas le droit de modifier le mot de passe de ce compte.";
    default:
      return null;
  }
}
    ...
    <SiteShell>
      <div className="grid gap-6">
        ...
        <div className="grid gap-4">
          {rows.map((player) => (
            <div key={player.id} className="neon-card p-5 md:p-6">
              <div className="grid gap-4">
                <div className="flex flex-col gap-4 2xl:flex-row 2xl:items-start 2xl:justify-between">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="neon-badge">{player.role}</span>
                      <span className="neon-badge">{player.status}</span>
                    ...
                    <p className="neon-text-muted mt-3 text-sm">{player.email}</p>
                  </div>

                  <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                    <div className="neon-card-soft min-w-[145px] p-3">
                    ...
                    <div className="neon-card-soft min-w-[145px] p-3">
                      ...
                      <p className="mt-1.5 text-sm font-semibold text-white">
                        {player.activeWarnings} actif{player.activeWarnings > 1 ? "s" : ""} /{" "}
